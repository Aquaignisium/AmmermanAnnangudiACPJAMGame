...
def game(username):
    ...
    print("\n")
    print("How would you like to respond \nResponce 1:" "Yeah I'll just get this over with already.""\nResponce 2:" "I'll start out small what more can you tell me about the Giggle Gang" "\nResponce 3: Well the other two sounded a little too dangerous and I want to have some fun")
    ...
    print("One last thing before you leave, what name would you like while undercover?")
